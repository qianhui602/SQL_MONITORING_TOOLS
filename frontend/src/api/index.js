...
export function exportDeadlocks(params) { return request.get('/export/deadlocks', { params, responseType: 'blob', timeout: 600000 }) }
export function exportSlowQueries(params) { return request.get('/export/slow-queries', { params, responseType: 'blob', timeout: 600000 }) }
