export default {
  ...
  settings: {
    ...
    wecomChannel: '企业微信',
    feishuAppChannel: '飞书应用通知',
    smtpChannel: 'SMTP 邮件',
    feishuWebhookChannel: '飞书 Webhook',
    ...
    feishuOpenId: '接收人',
    feishuOpenIdDesc: '接收通知用户的邮箱地址或 open_id（以 ou_ 开头）',
    feishuSendTest: '发送测试消息',
    feishuTestFailed: '测试失败:',
    feishuToggle: '飞书 Webhook 通知开关',
    feishuToggleDesc: '是否通过飞书群机器人 Webhook 发送告警通知',
    feishuWebhook: '飞书 Webhook URL',
    feishuWebhookDesc: '飞书群机器人 Webhook 地址',
